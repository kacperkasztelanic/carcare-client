  ...
  toggleDetailsPopover = (id: number) => {
    this.setState({
      openPopovers: this.state.openPopovers.includes(id)
        ? [...this.state.openPopovers].filter(x => x !== id)
        : [...this.state.openPopovers, id]
    });
  };
          ...
          <Row>
            <Col md="4" sm="12">
              <FormGroup>
                ...
                <Input
                  ...
                  id="vehicleSelectMultiple"
                  onChange={this.onVehiclesSelect}
                >
            ...
            <Col md="4" sm="12">
              ...
              <div className="text-right">
                ...
                >
                  <FontAwesomeIcon icon="search" /> <Translate contentKey="carcare.forthcoming-events.search">Search</Translate>
                </Button>
              </div>
            </Col>
          </Row>
                ...
                <Table responsive striped>
                  <thead>
                    <tr>
                      ...
                      <th>
                        <Translate contentKey="carcare.forthcoming-events.by-mileage" interpolate={{ unit: 'km' }}>
                          By mileage
                        </Translate>
                      </th>
                      <th>
                      ...
                      <tr id={`i`} key={`event-${i}`}>
                        ...
                        <td>
                          ...
                          <span className="d-none d-md-inline">
                            {e.details.slice(0, APP_COMPACT_DETAILS_LENGTH * 2 - 3) +
                              (e.details.length > APP_COMPACT_DETAILS_LENGTH * 2 ? '...' : '')}
                          </span>
