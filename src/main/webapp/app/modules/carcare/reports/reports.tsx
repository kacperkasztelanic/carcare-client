    ...
    return (
      <div>
        <Row>
          <Col md="6" sm="12">
            <h3>
              <FontAwesomeIcon icon="car" /> <Translate contentKey="carcare.reports.vehicle-report">Vehicle report</Translate>
            </h3>
            <hr />
            <Form>
              <FormGroup>
              ...
              <div className="text-center">
                ...
                >
                  <FontAwesomeIcon icon="file-excel" /> <Translate contentKey="carcare.reports.generate">Generate</Translate>
                </Button>
              </div>
            </Form>
          </Col>
          <Col md="6" sm="12">
            <h3>
              <FontAwesomeIcon icon="dollar-sign" /> <Translate contentKey="carcare.reports.cost-report">Cost report</Translate>
            </h3>
            <hr />
            <Form>
              <FormGroup>
